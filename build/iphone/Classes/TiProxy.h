...
//Rare exceptions to indicate a bug in the _tibountyhunter code (Eg, function that a subclass should have implemented)
...
/**
 The base class for TiBountyHunter proxies.
 */
