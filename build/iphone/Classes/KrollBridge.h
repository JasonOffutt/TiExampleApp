...
@interface TiBountyHunterObject : KrollCoverageObject {
#else
@interface TiBountyHunterObject : KrollObject {
#endif
@private
...
extern NSString * TiBountyHunter$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	TiBountyHunterObject *_tibountyhunter;
    KrollObject* console;
	BOOL shutdown;
