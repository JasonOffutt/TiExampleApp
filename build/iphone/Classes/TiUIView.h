...
/**
 Base class for all TiBountyHunter views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the TiBountyHunter view hierarchy (such as wrapped iOS UIViews) was touched.
