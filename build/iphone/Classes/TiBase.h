...
// in simulator we redefine to format for TiBountyHunter Developer console
...
{\
	NSString * exceptionName = [@"org.tibountyhunter." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tibountyhunter";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITiBountyHunterNativeItemNone = -1, 
	UITiBountyHunterNativeItemSpinner = -2,
	UITiBountyHunterNativeItemProgressBar = -3,
	
	UITiBountyHunterNativeItemSlider = -4,
	UITiBountyHunterNativeItemSwitch = -5,
	UITiBountyHunterNativeItemMultiButton = -6,
	UITiBountyHunterNativeItemSegmented = -7,
	
	UITiBountyHunterNativeItemTextView = -8,
	UITiBountyHunterNativeItemTextField = -9,
	UITiBountyHunterNativeItemSearchBar = -10,
	
	UITiBountyHunterNativeItemPicker = -11,
	UITiBountyHunterNativeItemDatePicker = -12,
	
	UITiBountyHunterNativeItemInfoLight = -13,
	UITiBountyHunterNativeItemInfoDark = -14,
	
	UITiBountyHunterNativeItemDisclosure = -15,
	
	UITiBountyHunterNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TiBountyHunter instances of
