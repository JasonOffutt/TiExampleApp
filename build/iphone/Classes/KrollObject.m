 ...
 * Copyright (c) 2009-2011 by TiBountyHunter, Inc. All Rights Reserved.
...
//@interface TiBountyHunterObject : NSObject
//@end

@interface TiBountyHunterObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TiBountyHunterObject class]])
		{
			for (NSString *key in [[(TiBountyHunterObject*)o modules] allKeys])
			{
